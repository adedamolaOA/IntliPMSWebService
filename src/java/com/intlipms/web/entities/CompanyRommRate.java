...
@NamedQueries({
    ...
    , @NamedQuery(name = "CompanyRommRate.findByGlobalId", query = "SELECT c FROM CompanyRommRate c WHERE c.globalId = :globalId")
...
public class CompanyRommRate implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.CompanyRommRate[ roomrateid=" + roomrateid + " ]";
    }

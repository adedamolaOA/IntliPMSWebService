...
@NamedQueries({
    ...
    , @NamedQuery(name = "MaintRequest.findByGlobalId", query = "SELECT m FROM MaintRequest m WHERE m.globalId = :globalId")
...
public class MaintRequest implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.MaintRequest[ requestid=" + requestid + " ]";
    }

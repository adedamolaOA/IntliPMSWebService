...
@NamedQueries({
    ...
    , @NamedQuery(name = "CompanyPrivileges.findByGlobalId", query = "SELECT c FROM CompanyPrivileges c WHERE c.globalId = :globalId")
...
public class CompanyPrivileges implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.CompanyPrivileges[ pid=" + pid + " ]";
    }

...
@NamedQueries({
    ...
    , @NamedQuery(name = "CustomerPrivileges.findByGlobalId", query = "SELECT c FROM CustomerPrivileges c WHERE c.globalId = :globalId")
...
public class CustomerPrivileges implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.CustomerPrivileges[ pid=" + pid + " ]";
    }

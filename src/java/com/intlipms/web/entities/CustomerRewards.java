...
@NamedQueries({
    ...
    , @NamedQuery(name = "CustomerRewards.findByGlobalId", query = "SELECT c FROM CustomerRewards c WHERE c.globalId = :globalId")
...
public class CustomerRewards implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.CustomerRewards[ pid=" + pid + " ]";
    }

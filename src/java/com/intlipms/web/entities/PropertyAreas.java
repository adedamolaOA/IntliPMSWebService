...
@NamedQueries({
    ...
    , @NamedQuery(name = "PropertyAreas.findByGlobalId", query = "SELECT p FROM PropertyAreas p WHERE p.globalId = :globalId")
...
public class PropertyAreas implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.PropertyAreas[ areaid=" + areaid + " ]";
    }

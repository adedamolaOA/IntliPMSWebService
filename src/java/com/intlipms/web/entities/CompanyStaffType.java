...
@NamedQueries({
    ...
    , @NamedQuery(name = "CompanyStaffType.findByGlobalId", query = "SELECT c FROM CompanyStaffType c WHERE c.globalId = :globalId")
...
public class CompanyStaffType implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.CompanyStaffType[ id=" + id + " ]";
    }

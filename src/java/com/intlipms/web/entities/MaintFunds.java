...
@NamedQueries({
    ...
    , @NamedQuery(name = "MaintFunds.findByGlobalId", query = "SELECT m FROM MaintFunds m WHERE m.globalId = :globalId")
...
public class MaintFunds implements Serializable {
    ...
    public String toString() {
        return "com.intlipms.web.entities.MaintFunds[ fundId=" + fundId + " ]";
    }
